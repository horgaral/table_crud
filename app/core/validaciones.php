 ...
 * @author Lopandpe <lopandpe@gmail.com>
 * @since 20130130
 */
class Validaciones  {
...
// Para cada entrada se define: "columna"=>"validador" // Tipo de datos sql de la columna en la tabla
        ...
        public static function errores_email($cadena) {
         ...
         /**
         * Valida un valor numérico de 4 cifras y determina si es menor al año actual.
         * Ejemplo 1996, 1453, 0454, etc.
         * 
         * @param string $cadena
         * @return boolean|string
         */
        public static function errores_anio_pasado($cadena=null) {
                ...
                if( $cadena > date ("Y"))
                                $mensaje ="-php- Error: Imposible utilizar una fecha futura. Carpe Diem.";
         ...
         /**
         * Valida que la longitud de la cadena sea inferior o igual a 10 caracteres.
         * Ejemplo "Pepito", "123456789", "casi diez"
         * 
         * @param string $cadena
         * @return boolean|string
         */
        public static function errores_tamanio_10($cadena=null) {
                ...
                if ( ! is_null($cadena) && strlen($cadena)) {
                        $patron="/^\w{0,10}$/";
                        if( ! preg_match($patron, $cadena))
                                $mensaje ="-php- Error: La longitud no puede sobrepasar los 10 caracteres";
                }
         ...
         /**
         * Valida que la longitud de la cadena sea inferior o igual a 4 caracteres.
         * Ejemplo "Pepe", "1234", "hola", "sol"
         * 
         * @param string $cadena
         * @return boolean|string
         */
        public static function errores_tamanio_4($cadena=null) {
                ...
                if ( ! is_null($cadena) && strlen($cadena)) {
                        $patron="/^[\w|&]{0,4}$/";
                        if( ! preg_match($patron, $cadena))
                                $mensaje ="-php- Error: La longitud no puede sobrepasar los 4 caracteres";
                }
        ...
        /**
         * Valida que la longitud de la cifra sea inferior o igual a 4 números.
         * Ejemplo "4000", "1234", "2012", "69", "666"
         * 
         * @param string $cadena
         * @return boolean|string
         */
        public static function errores_numeros_4($cadena=null) {
                ...
                if ( ! is_null($cadena) && strlen($cadena)) {
                        $patron="/^\d{0,4}$/";
                        if( ! preg_match($patron, $cadena))
                                $mensaje ="-php- Error: El número no puede exceder las 4 cifras";
                }
         ...
         /**
         * Cadena representa una fecha con el formato dd/mm/aaaa. La convierte a aaa/mm/dd
         * @param type $cadena
         * @return boolean
         */
        public static function errores_fecha_dia_mes_anio($cadena){
                $mensaje="";
                if ($cadena!=null) {
                        $cadena=str_replace(array(' ', '/', '.', ',', ':'), '-', $cadena);
                        /* Para que sea mas facil y ahorrar comprobaciones cambiamos por - todos los signos que pone en el array, de esta manera la fecha siempre sera del tipo dd-mm-aaaa */
                        $trozos = array();
                        $patron_fecha_hora="/^\d{1,2}\-\d{1,2}\-\d{4}/";
                        if (preg_match($patron_fecha_hora, $cadena)) {
                            $trozos = explode('-', $cadena); //con explode convertimos en subcadenas el array cadena, cada subcadena esta formada por la division que hace el caracter.
                                if (($trozos[0] > 31) | ($trozos[1] > 12) | ($trozos[2] > date ("Y")))
                                        $mensaje="La fecha es errónea . Revísela. El formato es dd/mm/aaaa bla";
                                
                        }
                        else
                                $mensaje="La fecha es errónea. Revísela. El formato es dd/mm/aaaa";
                }
                if ($mensaje=="") $mensaje=false;
                return $mensaje;
        }       
